...
export default function EditBotModal({ bot, onClose, onSuccess }: Props) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      await updateBot(bot.id, name.trim(), description.trim() || undefined);
      onSuccess();
    } catch (err) {
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <h2 style={{ marginTop: 0, marginBottom: '16px' }}>Edit Bot</h2>
